...
- Phase 1: actively migrated with core-emitted patch edits for CV001/CV004 and CLI ingestion; CV004 legacy AST rewrite path removed in favor of core patch metadata.
